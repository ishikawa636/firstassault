Arena = function(game) {
    ...
    materialWall.diffuseTexture = new BABYLON.Texture("assets/images/Floor_Tile_KDH_04.jpg", scene);
    ...
    BABYLON.SceneLoader.ImportMesh("", "assets/blender/", "car01.babylon", scene, function(){
      console.log("blender mesh imported");
    });
};
